...
class JobSeeker extends Model
{
     ...
     */
    protected $fillable = [
        'user_id', 'name', 'surname', 'patronymic', 'date_of_birth', 'city_id', 'phone', 'address', 'gender', 'show_data'
    ];
    ...
    public function avatar($type = ImageModel::TYPE_JOB_SEEKER_AVATAR){
     ...
     * @return string
     */
    public function getKeyForCachingAvatars($type = ImageModel::TYPE_JOB_SEEKER_AVATAR){
        return implode( '_', [
            'avatar_jb',
            $this->attributes['id'],
            $type
     ...
     * @return string
     */
    public function getNameToAddAvatarsToCache(){
        return implode( '_', [
            self::class,
            $this->user_id,
            $this->id,
    ...
    public function respondVacancy(){
        return $this->hasMany('App\RespondVacancy', 'job_seeker_id', 'id');
    }
