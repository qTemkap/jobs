<template>
    <div>
        ...
        <form class="auth-form" @keypress.enter.prevent @submit.prevent="loginSubmit">
            ...
            <div class="input-group input-group__recovery">
                ...
                <a href="/password/reset" class="link-dots">Восстановить пароль</a>
            </div>
