    ...
    <div>
        ...
        >
            ...
            <div class="empty-list__desc">
                Создайте вакансию, чтобы быстро и эффективно найти хорошого сотрудника.
            </div>

            <!--            <div class="empty-list__wrapper">-->
            <!--                <div class="empty-list__item">-->
            <!--                    Мы поможем создать профессиональную вакансию, которая отвечает всем современным требованиям.-->
            <!--                </div>-->
            <!--                <div class="empty-list__item">-->
            ...
            <a href="/vacancy/create" class="btn btn-green empty-list__btn">Создать вакансию</a>

        </section>

        <section class="resume-card__wrapper"
                 v-else>
            <div class="top-btn-create">
                <a href="/vacancy/create" class="btn btn-green empty-list__btn">Создать вакансию</a>
            </div>

            <div class="tabs">
                <a @click="activeTab=1" :class="[ activeTab === 1 ? 'active' : '' ]">Активные ({{activeCard().length}})</a>
                <a @click="activeTab=2" :class="[ activeTab === 2 ? 'active' : '' ]">Все ({{cardList.length}})</a>
            </div>
            ...
            <div class="tub-content">
                <div v-if="activeTab === 1" class="tabcontent">
                    <app-vacancy-card
                            ...
                            :cardCites="card.cities[0].name"
                            :cardTitle="card.position"
                            :cardSalary="card.salary"
                            :feedbackLink="card.responses"
                            :feedbackCount="card.count_of_responses"
                            :cardId="card.id"
                            :hitCount="card.hit_counter"
...
<script>
    ...
    import AppVacancyCard from './AppVacancyCard';
    ...
    export default {
        ...
        created(){
            this.cardList = JSON.parse(this.data);
        ...
        methods: {
          ...
          activeCard(){
              return this.cardList.filter((active) => {
                  return active.published === 1
              })
          }
