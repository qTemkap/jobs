...
<aside class="sidebar">
    <ul class="ul-reset">
        <li>
            <a href="{{ route('summary.list') }}" class="{{ request()->is('summaries') ? 'active' : '' }} sidebar__link">
                <img src="/images/sidebar/sidebar-2.png" class="img-fluid" alt="">
                Мои резюме
            </a>
        </li>
        <li>
            <a href="{{ route('vacancies.favorite') }}" class="{{ request()->is('vacancies/favorite') ? 'active' : '' }} sidebar__link">
        ...
        {{--<li>--}}
            {{--<a href="#" class="sidebar__link">--}}
                {{--<img src="/images/sidebar/sidebar-3.png" class="img-fluid" alt="">--}}
                {{--Мои отклики--}}
            {{--</a>--}}
        {{--</li>--}}
        <li>
            <a href="{{ route('profile') }}" class="{{ request()->is('profile') ? 'active' : '' }} sidebar__link">
