...
<head>
    ...
    <style>
       ...
       .info-date {
        ...
        .print-content__item ul{
            padding: 0;
            margin: 0;
        }
        .print-content__item li{
            font-weight: 600;
            font-size: 0.9375rem;
            line-height: 1;
            position: relative;
        ...
        .print-content__item li .grey-text{
            line-height: 1;
        }
    ...
    <div class="print-container" style="margin-bottom: 25px;">
        ...
        <div class="resume-preview" style="clear:both">
            ...
            <table class="general-info">
                ...
                <tr>
                    <td class="user-info__block">
                        <table>
                            <tr>
                                <td>
                                    <div class="info-date">
                                        Резюме от {{$summary['published_at']}}
                                    </div>
                    ...
                    <td class="main-info__photo">
                        ...
                        @endif
                            <!-- <img src="http://edhh.webra-dev.com/images/profile-preview-null.jpg" class="img-fluid" alt=""> -->
                    </td>
                </tr>
            ...
            <div class="print-content">
                ...
                @foreach($experiences as $exp)
                    <div class="print-content__item">
                        ...
                        <p>
                            с {{ $exp['worked_with']  }} по {{$exp['worked_to']}} ({{ $exp['duration_of_training']}})
                            <br>
                    ...
                    @foreach($educations as $education)
                        <div class="print-content__item">
                            ...
                            <p>
                                ...
                                ({{ $education['duration_of_training']  }})
                                </span>
                            </p>
                        </div>
                    @endforeach
            ...
            <div class="print-content">
                ...
                <div class="print-content print-content-dop print-content-last">
                    <h2>
